...
class FloatSliderWidget(BaseSliderWidget):
    ...
    def __init__(self, min_value=None, max_value=None, start_value=None, is_horizontal=False,
                 spacing=4, margins=QtCore.QMargins(1, 1, 1, 1), parent=None):
        super(FloatSliderWidget, self).__init__(min_value=min_value, max_value=max_value, start_value=start_value, is_horizontal=is_horizontal,
...
class IntegerSliderWidget(BaseSliderWidget):
    ...
    def __init__(self, min_value=None, max_value=None, start_value=None, is_horizontal=False,
                 spacing=4, margins=QtCore.QMargins(1, 1, 1, 1), parent=None):
        super(IntegerSliderWidget, self).__init__(min_value=min_value, max_value=max_value, start_value=start_value, is_horizontal=is_horizontal,
                                                  spacing=4, margins=QtCore.QMargins(1, 1, 1, 1), parent=parent)
